...
//         A função ImprimePlacar deve ser chamada dentro da renderScene para imprimir o placar na posição (relativo à janela de visualização) desejada
    ...
    char *tmpStr;
    sprintf(str, "Acertos: %d", colisao );
    //Define a posicao onde vai comecar a imprimir
    glRasterPos2f(x, y);
    //Imprime um caractere por vezatingido
    tmpStr = str;
    while( *tmpStr ){
...
{
//- DICAS:
//          utilize a diferença de tempo timeDiference para corrigir o movimento do tiro
//          Passe timeDiference para a função move do tiro e multiplique pelo cálculo do incremento da distância (distância = velocidade * tempo)
